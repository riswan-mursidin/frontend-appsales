...
// warna detail merek
$querywarna = mysqli_query($conn, "SELECT foto_warna,ket_warna FROM warna_merek WHERE id_merek='$rowmerekdetail[id_merek]' AND id_admin='26' ");
...
// info promo
$querypromo = mysqli_query($conn, "SELECT * FROM promo_mobil WHERE id_admin='26' ORDER BY id_promo DESC LIMIT 2");
