<?php  
include "koneksi.php";
$query = mysqli_query($conn, "SELECT * FROM profil_admin WHERE id_admin='26'");
...
if(isset($_POST['aksikostumer'])){
    ...
    $pesan = $_POST['pesan'];
    $querycostumer = "INSERT INTO costumer (nama_costumer,kota_costumer,no_costumer,typemobil_costumer,pesansingkat_costumer,pesan_costumer,id_admin) VALUES ('$nama','$kota','$no','$typemobil','$permintaan','$pesan','26')";
